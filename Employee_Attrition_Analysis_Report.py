...
df = pd.read_csv('/Users/ceo/Desktop/Predicting-Employee-Turnover-Complete-Guide-Analysis-master/HR Analytics Employee Turnover/HR_comma_sep.csv', index_col=None)
...
sns.distplot(df.averageMonthlyHours, kde=False, color="c", ax=axes[2]).set_title('Employee Average Monthly Hours Distribution')
